...
class DesignationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('designation.index' ,compact('designation_list'));
    }
    ...
    public function store(Request $request)
    {
         ...
         $request->validate(
            [
                'designation_name'=>'required|string|min:4',
            ]);
   ...
   public function changeDesignationStatus(Request $request)
    ...
    public function designationDestroy(Request $request){
        ...
        $destroy = Designation::where('designation_id', $request->designation_id)->delete();
