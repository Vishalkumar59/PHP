...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('role.index',compact('role_list','permission_list'));
    }
    ...
    public function create()
    {
        ...
        $permission_list = Permission::all();
        return view('role.create' , compact('permission_list','module_name','module_section'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('role.edit', compact('role_list','permission_list','rolePermissionList','module_name','module_section'));
    }
    ...
    public function destroy($roles_id)
    {
        ...
        return redirect()->route('role.index')->with('danger','Record delete successfully');
    }
