...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        $customer_list = Customer::orderBy('created_at', 'DESC')->get();
        return view('customer.index', compact('customer_list','contact'));
    }
    ...
    public function create()
    {
        ...
        return view('customer.create', compact('lead_list','country_list'));
    }
    ...
    public function edit($id)
    {
        ...
        $country_list   = MasCountry::all();
        return view('customer.edit',compact('customer','lead_list','address','country_list','contacts'));
    }
